...
/**
 * Base de las pantallas de entrada de N7 → «La Sala de Situación»
 * (unidad `n7-ciudadania-digital-critica`, documento §30, línea de canon
 * «Ciudadanía digital crítica»). Misma «plantilla de oro» calcada de
 * `EntradaN5Base.tsx`/`EntradaN6Base.tsx`, sólo con el nombre del nivel
...
/** N7·«Ciudadanía digital crítica»: las tres paradas de la unidad (currículo). */
export const RUTA_N7_CIUDADANIA_DIGITAL_CRITICA: PasoRuta[] = [
  { id: 'n7-privacidad-en-redes', titulo: 'Privacidad en redes' },
  { id: 'n7-riesgos-y-marco-legal', titulo: 'Riesgos en línea y marco legal' },
  { id: 'n7-equilibrio-digital', titulo: 'Equilibrio digital' },
];
...
export interface ConfigEntradaN7Situacion {
  actividadId: string;
...
export function EntradaN7SituacionBase({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN7Situacion }) {
...
export default EntradaN7SituacionBase;
