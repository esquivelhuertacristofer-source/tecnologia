...
/**
 * Base de las pantallas de entrada de la Unidad 3 (documento §4).
 *
 * Es la plantilla de oro con la única variación permitida entre unidades:
 * la ruta. La sala «Las máquinas de pensar» tiene tres paradas y las tres
 * tienen entrada propia, así que la parada del CTA va de 1 a 3. Todo lo
...
const RUTA_UNIDAD3: PasoRuta[] = [
  { id: 'n1-ordena-los-pasos', titulo: 'Ordena los pasos' },
  { id: 'n1-sigue-el-patron', titulo: 'Sigue el patrón' },
  { id: 'n1-quien-usa-que', titulo: '¿Quién usa qué?' },
];
...
export interface ConfigEntradaUnidad3 {
...
export function EntradaUnidad3Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaUnidad3 }) {
  ...
  const idxActual = RUTA_UNIDAD3.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaUnidad3Base;
