...
/**
 * Base de las pantallas de entrada de la Unidad 5 (documento §6).
 *
 * Es la plantilla de oro con la única variación permitida entre unidades:
 * la ruta. La sala «Me cuido con la compu» tiene tres paradas y las tres
 * llevan entrada propia, así que la parada del CTA va de 1 a 3. Todo lo
...
const RUTA_UNIDAD5: PasoRuta[] = [
  { id: 'n1-semaforo-de-pantalla', titulo: 'El semáforo de la pantalla' },
  { id: 'n1-pide-ayuda', titulo: 'Pido ayuda a un adulto' },
  { id: 'n1-mis-datos-son-un-tesoro', titulo: 'Mis datos son un tesoro' },
];
...
export interface ConfigEntradaUnidad5 {
...
export function EntradaUnidad5Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaUnidad5 }) {
  ...
  const idxActual = RUTA_UNIDAD5.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaUnidad5Base;
