...
/**
 * Base de las pantallas de entrada de N3·U6 «La IA a mi alrededor»
 * (documento §21). Es la misma plantilla de oro heredada de N1·U5, N2·U1,
 * N3·U2, N3·U3, N3·U4 y N3·U5 sin ningún cambio — la única variación permitida
...
const RUTA_N3U6: PasoRuta[] = [
  { id: 'n3-la-ia-en-mi-dia', titulo: 'La IA en mi día' },
  { id: 'n3-piensan-las-maquinas', titulo: '¿Piensan las máquinas?' },
  { id: 'n3-la-ia-se-equivoca', titulo: 'La IA se equivoca' },
];
...
export interface ConfigEntradaN3Unidad6 {
...
export function EntradaN3Unidad6Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN3Unidad6 }) {
  ...
  const idxActual = RUTA_N3U6.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN3Unidad6Base;
