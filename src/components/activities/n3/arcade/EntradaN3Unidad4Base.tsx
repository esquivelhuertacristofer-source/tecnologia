...
/**
 * Base de las pantallas de entrada de N3·U4 «Programación en bloques I»
 * (documento §19). Es la misma plantilla de oro heredada de N1·U5, N2·U1,
 * N3·U2 y N3·U3 sin ningún cambio — la única variación permitida entre
 * unidades es la ruta, que aquí tiene tres paradas.
 */
...
const RUTA_N3U4: PasoRuta[] = [
  { id: 'n3-conoce-scratch', titulo: 'Conoce Scratch' },
  { id: 'n3-eventos-y-movimiento', titulo: 'Eventos y movimiento' },
  { id: 'n3-mi-primera-animacion', titulo: 'Mi primera animación' },
];
...
export interface ConfigEntradaN3Unidad4 {
...
export function EntradaN3Unidad4Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN3Unidad4 }) {
  ...
  const idxActual = RUTA_N3U4.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN3Unidad4Base;
