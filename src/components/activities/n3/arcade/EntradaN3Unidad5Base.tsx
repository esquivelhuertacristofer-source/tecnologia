...
/**
 * Base de las pantallas de entrada de N3·U5 «Procesador de textos I»
 * (documento §20). Es la misma plantilla de oro heredada de N1·U5, N2·U1,
 * N3·U2, N3·U3 y N3·U4 sin ningún cambio — la única variación permitida entre
...
const RUTA_N3U5: PasoRuta[] = [
  { id: 'n3-dale-formato', titulo: 'Dale formato' },
  { id: 'n3-ortografia-e-imagenes', titulo: 'Ortografía e imágenes' },
  { id: 'n3-la-fila-guia', titulo: 'La fila guía' },
];
...
export interface ConfigEntradaN3Unidad5 {
...
export function EntradaN3Unidad5Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN3Unidad5 }) {
  ...
  const idxActual = RUTA_N3U5.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN3Unidad5Base;
