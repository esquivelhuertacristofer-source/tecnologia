...
/**
 * Base de las pantallas de entrada de N3·U3 «Internet seguro» (documento §18).
 * Es la misma plantilla de oro heredada de N1·U5, N2·U1 y N3·U2 sin ningún
 * cambio — la única variación permitida entre unidades es la ruta, que aquí
...
const RUTA_N3U3: PasoRuta[] = [
  { id: 'n3-que-es-internet', titulo: '¿Qué es internet?' },
  { id: 'n3-busca-con-palabras-clave', titulo: 'Busca con palabras clave' },
  { id: 'n3-detector-de-sitios-confiables', titulo: 'Detector de sitios confiables' },
  { id: 'n3-netiqueta-y-contrasenas', titulo: 'Netiqueta y contraseñas' },
];
...
export interface ConfigEntradaN3Unidad3 {
...
export function EntradaN3Unidad3Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN3Unidad3 }) {
  ...
  const idxActual = RUTA_N3U3.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN3Unidad3Base;
