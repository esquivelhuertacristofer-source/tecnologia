...
/**
 * Base de las pantallas de entrada de N3·U2 «Hardware y software»
 * (documento §17). Es la misma plantilla de oro heredada de N1·U5 y N2·U1 sin
...
const RUTA_N3U2: PasoRuta[] = [
  { id: 'n3-hardware-o-software', titulo: '¿Hardware o software?' },
  { id: 'n3-explora-el-escritorio', titulo: 'Explora el escritorio' },
  { id: 'n3-carpetas-y-atajos', titulo: 'Carpetas y atajos' },
];
...
export interface ConfigEntradaN3Unidad2 {
...
export function EntradaN3Unidad2Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN3Unidad2 }) {
  ...
  const idxActual = RUTA_N3U2.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN3Unidad2Base;
