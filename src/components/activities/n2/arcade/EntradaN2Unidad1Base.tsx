...
/**
 * Base de las pantallas de entrada de N2·U1 «Dispositivos a mi alrededor»
 * (documento §9). Es la misma plantilla de oro heredada de N1·U5 sin
...
const RUTA_N2U1: PasoRuta[] = [
  { id: 'n2-safari-de-dispositivos', titulo: 'Safari de dispositivos' },
  { id: 'n2-entrada-o-salida', titulo: '¿Entrada o salida?' },
  { id: 'n2-donde-viven-mis-archivos', titulo: '¿Dónde viven mis archivos?' },
];
...
export interface ConfigEntradaN2Unidad1 {
...
export function EntradaN2Unidad1Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN2Unidad1 }) {
  ...
  const idxActual = RUTA_N2U1.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN2Unidad1Base;
