...
/**
 * Base de las pantallas de entrada de N2·U3 «Ventanas, archivos y carpetas»
 * (documento §11). Es la misma plantilla de oro heredada de N1·U5, N2·U1 y
 * N2·U2 sin ningún cambio — la única variación permitida entre unidades es la ruta.
 */
...
const RUTA_N2U3: PasoRuta[] = [
  { id: 'n2-abre-y-cierra-ventanas', titulo: 'Abre y cierra ventanas' },
  { id: 'n2-guarda-y-encuentra', titulo: 'Guarda y encuentra tu trabajo' },
];
...
export interface ConfigEntradaN2Unidad3 {
  ...
  /** Número de parada en la ruta de la unidad (1–2); es el número gigante del CTA. */
  parada: number;
  globo: string;
  arranqueSub: string;
...
export function EntradaN2Unidad3Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN2Unidad3 }) {
  ...
  const idxActual = RUTA_N2U3.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN2Unidad3Base;
