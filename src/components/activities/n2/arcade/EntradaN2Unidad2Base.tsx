...
/**
 * Base de las pantallas de entrada de N2·U2 «El rincón del teclado»
 * (documento §10). Es la misma plantilla de oro heredada de N1·U5 y N2·U1
...
const RUTA_N2U2: PasoRuta[] = [
  { id: 'n2-explora-tu-teclado', titulo: 'Explora tu teclado' },
  { id: 'n2-mayusculas-y-acentos', titulo: 'Mayúsculas y acentos' },
  { id: 'n2-escribe-a-dos-manos', titulo: 'Escribe a dos manos' },
];
...
export interface ConfigEntradaN2Unidad2 {
...
export function EntradaN2Unidad2Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN2Unidad2 }) {
  ...
  const idxActual = RUTA_N2U2.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN2Unidad2Base;
