...
/**
 * Base de las pantallas de entrada de N2·U4 «Algoritmos con juegos»
 * (documento §12). Es la misma plantilla de oro heredada de N1·U5 y N2·U1–U3
...
const RUTA_N2U4: PasoRuta[] = [
  { id: 'n2-laberinto-de-bloques', titulo: 'El laberinto de bloques' },
  { id: 'n2-caza-el-error', titulo: 'Caza el error' },
  { id: 'n2-repite-repite', titulo: '¡Repite, repite! (bucles)' },
];
...
export interface ConfigEntradaN2Unidad4 {
...
export function EntradaN2Unidad4Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN2Unidad4 }) {
  ...
  const idxActual = RUTA_N2U4.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN2Unidad4Base;
