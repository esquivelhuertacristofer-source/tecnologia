...
/**
 * Base de las pantallas de entrada de N2·U6 «Ciudadanía digital»
 * (documento §14). Es la misma plantilla de oro heredada de N1·U5 y N2·U1–U5
...
const RUTA_N2U6: PasoRuta[] = [
  { id: 'n2-secreto-o-publico', titulo: '¿Secreto o público?' },
  { id: 'n2-con-quien-hablo', titulo: '¿Con quién sí hablo en línea?' },
  { id: 'n2-heroes-del-respeto', titulo: 'Héroes del respeto' },
];
...
export interface ConfigEntradaN2Unidad6 {
...
export function EntradaN2Unidad6Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN2Unidad6 }) {
  ...
  const idxActual = RUTA_N2U6.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN2Unidad6Base;
