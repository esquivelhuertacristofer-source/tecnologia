...
/**
 * Base de las pantallas de entrada de N2·U5 «Escribo y dibujo»
 * (documento §13). Es la misma plantilla de oro heredada de N1·U5 y N2·U1–U4
...
const RUTA_N2U5: PasoRuta[] = [
  { id: 'n2-mis-primeras-oraciones', titulo: 'Mis primeras oraciones' },
  { id: 'n2-viste-tus-letras', titulo: 'Viste tus letras' },
  { id: 'n2-cuento-ilustrado', titulo: 'Mi cuento ilustrado' },
];
...
export interface ConfigEntradaN2Unidad5 {
...
export function EntradaN2Unidad5Base({ entrada, ...props }: ActivityProps & { entrada: ConfigEntradaN2Unidad5 }) {
  ...
  const idxActual = RUTA_N2U5.findIndex((paso) => paso.id === entrada.actividadId);
...
export default EntradaN2Unidad5Base;
