...
/**
 * Banco de pruebas del port de `n2-cuento-ilustrado` — /banco-word/p-cuento-ilustrado.
 *
 * Monta el laboratorio solo, sin entrada ni anfitrión, y deja los eventos del
 * contrato a la vista en un nodo de un píxel para poder leerlos desde la sonda.
 *
 ...
 * El laboratorio viejo sigue en su sitio y sigue siendo el que juega el alumno.
 */
export default function PaginaBancoCuentoIlustrado() {
